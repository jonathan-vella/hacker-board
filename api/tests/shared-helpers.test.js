...
describe("shared/cosmos", () => {
  it("exports getContainer, getDatabase, and nextHackerNumber functions", async () => {
    const cosmos = await import("../shared/cosmos.js").catch(() => undefined);
    if (cosmos) {
      expect(typeof cosmos.getContainer).toBe("function");
      expect(typeof cosmos.getDatabase).toBe("function");
      expect(typeof cosmos.nextHackerNumber).toBe("function");
    }
  });
});
