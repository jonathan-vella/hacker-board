...
Every API request includes the App Service Easy Auth context automatically. App Service Easy Auth supports two identity providers:
...
- [app-design.md](./app-design.md) — Architecture and component model
- [App Service Easy Auth](https://learn.microsoft.com/azure/app-service/overview-authentication-authorization)
- [App Service Authentication Context](https://learn.microsoft.com/azure/app-service/configure-authentication-user-identities)
