...
describe("TeamRoster", () => {
  ...
  it("renders teams with their members", async () => {
    api.teams.list.mockResolvedValue([
      ...
      { teamName: "Team02", teamNumber: 2, teamMembers: [] },
    ]);
    api.attendees.list.mockResolvedValue([
      { alias: "Team01-Hacker01", teamName: "Team01" },
      { alias: "Team01-Hacker02", teamName: "Team01" },
      { alias: "Team02-Hacker01", teamName: "Team02" },
    ]);
    ...
    expect(container.textContent).toContain("Team02-Hacker01");
  });
  ...
  it("shows teams with no members", async () => {
    api.teams.list.mockResolvedValue([
      { teamName: "Empty Team", teamNumber: 1, teamMembers: [] },
    ]);
    api.attendees.list.mockResolvedValue([]);
